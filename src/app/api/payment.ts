...
export const getPaymentList = async () => {
  try {
    ...
    console.error('Error fetching payment list:', (error as Error).message);
    throw error;
  }
};

// Fungsi untuk mendapatkan saran pembayaran
export const getPaymentSuggest = async () => {
  try {
    ...
    console.error('Error fetching payment suggest:', (error as Error).message);
    throw error;
  }
};
